...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { boolean: @todo_item.boolean, completed: @todo_item.completed, date: @todo_item.date, description: @todo_item.description, due_date: @todo_item.due_date, title: @todo_item.title }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { boolean: @todo_item.boolean, completed: @todo_item.completed, date: @todo_item.date, description: @todo_item.description, due_date: @todo_item.due_date, title: @todo_item.title }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
